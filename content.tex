...
for trees. The first uses limits to define the join, but does not satisfy
...
In \cref{TODO}, we define SMB-trees a refinement of Brouwer trees that combines
the benefits of both versions of the maximum.
  \input{LimMax}
  \input{IndMax}

\section{Trees with a Striclty-Monotone Idempotent Join}
\input{InfinityMax}
\input{Idem}
